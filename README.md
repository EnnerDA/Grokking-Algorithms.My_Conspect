...
***На вский случай для себя отмечу, быстрая сортировка - выбор опорного элемента и распределение всех чисел относительно него влево и вправо, далее рекурсия до базы.

***А сортировка слиянием просто рекурсивное деление массива на половины до базы, без опорного.
***И та и длругая сортирвки имеют время O(n\*log(n))
